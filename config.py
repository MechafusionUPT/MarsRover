...
# IP CAMERA (telefon)
IP_CAMERA_URL = "http://10.146.163.97:8080/video"
IP_BUFFERSIZE = 1               # ca să nu acumulezi lag

# QR WORKER
QR_TARGET_FPS = 12              # cât de des procesezi cadrele
QR_JPEG_QUALITY = 70
QR_EMIT_INTERVAL = 1.0          # secunde: cât de des poți retrimite același text
